<template>
    <div class="container">
        ...
        <h3>Poděkování</h3>
        <p>
            Na pořádání Soběšické Muldy se podílí nepočítaně „bezejmenných“ pořadatelů - naši kamarádi a&nbsp;známí, rodinní příslušníci výše uvedeného organizačního týmu a&nbsp;jejich známí, atd.
            Ti se nám rozhodli zcela nezištně při pořádání závodu pomoci a&nbsp;bez jejichž účasti by nebylo v&nbsp;lidských silách hlavního šestičlenného pořadatelského týmu závod uspořádat.
            Nemůžeme zde všechny pořadatele vyjmenovat, protože bychom určitě na někoho zapomněli, ale tímto jim všem vyjadřujeme obrovský DÍK.
        </p>
    </div>
</template>
